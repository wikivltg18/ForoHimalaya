...
{{--
    ...
    Descripción: Formulario para registrar un nuevo usuario en el sistema de Desarrollo.
    Incluye validaciones, mensajes de error y selección de roles y áreas.
    Comentarios agregados para documentar cada sección y facilitar el mantenimiento.
--}}
...
@push('CSS')
    <style>
        /* Estilos personalizados para el formulario de creación de usuario */
        .mt-6{
