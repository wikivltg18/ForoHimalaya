...
{{--
    ...
    Descripción: Formulario para editar los datos de un usuario del equipo colaborador. Permite modificar datos personales, credenciales, rol y área asignada.
    Incluye estilos personalizados y botón para volver al listado de usuarios.
--}}
...
@push('CSS')
    {{-- Estilos y hojas de estilo para la vista de edición de usuario --}}
