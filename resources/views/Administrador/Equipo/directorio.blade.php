...
{{-- Muestra el directorio de usuarios y áreas, con opciones de filtrado y búsqueda. --}}
...
@section('template-blank-admin')
    ...
    @section('button-press')
        {{-- Botones para crear usuario y área --}}
    ...
    @push('CSS')
    <style>
        /* Estilos generales del contenedor y paginación */
        .general-container {
        ...
        /* Caja de cada usuario en el directorio */
    ...
    {{-- Filtros de búsqueda de usuarios y áreas --}}
    <div class="row">
        <div class="col-md-4">
    ...
    @push('JS')
    {{-- Script para búsqueda dinámica de usuarios por nombre --}}
    <script>
