...
{{-- Permite al administrador crear una nueva tarea/proyecto en el sistema. --}}
...
@section('template-blank-admin')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        {{-- Campos de fechas para tareas recurrentes --}}
    ...
    {{-- Script para inicializar select2 y búsqueda de proyectos --}}
    <script>
        $(document).ready(function() {
            $('#search').select2({
                ...
                minimumInputLength: 1, // Busca solo si hay al menos 1 caracter
                ajax: {
