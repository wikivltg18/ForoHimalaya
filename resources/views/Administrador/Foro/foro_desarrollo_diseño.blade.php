...
{{--
    Vista: foro_desarrollo_diseño.blade.php
    Descripción: Muestra el foro de desarrollo para el área de Diseño, permitiendo filtrar, buscar y visualizar tareas asociadas a OTs.
...
{{-- Filtros y acciones principales del foro de diseño --}}
<div class="p-2 pb-20">
...
<table class="table data-table stripe hover">
    ...
    <tbody>
        {{-- Itera sobre las tareas de diseño y muestra cada fila --}}
...
{{-- Fin de la vista foro_desarrollo_diseño.blade.php --}}
@endsection
