...
{{--
    Vista: profileAdmin.blade.php
    Descripción: Perfil del administrador, permite ver y editar información personal, foto de perfil, datos de contacto y habilidades.
    Incluye modal para actualizar imagen, tabs para timeline, tareas y configuración, y formularios de edición de datos.
--}}

<div class="row">
    {{-- Columna izquierda: Foto de perfil, datos personales y habilidades --}}
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
        <div class="pd-20 card-box height-100-p">
            {{-- Sección de foto de perfil y modal para actualizar imagen --}}
                            ...
                            <form action="{{ route('image.update') }}" enctype="multipart/form-data" method="POST">
                                <div class="modal-body pd-5">
                                    <div class="img-container">
                                        ...
                                        @method('PUT')
                                        <img id="image"
                                            src="{{ asset($userAuthenticate->img_perfil ? 'storage/images/' . $userAuthenticate->img_perfil : 'vendors/images/default.png') }}"
            ...
            {{-- Nombre, cargo y datos de contacto del usuario autenticado --}}
            ...
            {{-- Habilidades clave del usuario (progreso visual) --}}
    ...
    {{-- Columna derecha: Tabs de timeline, tareas y configuración --}}
